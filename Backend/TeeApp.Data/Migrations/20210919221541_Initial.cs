    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlockedByUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BlockedUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedUsers", x => new { x.BlockedByUsersId, x.BlockedUsersId });
                    table.ForeignKey(
                        name: "FK_BlockedUsers_Users_BlockedByUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestedUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RecievedUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    RequestedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ResponsedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendships", x => new { x.RequestedUserId, x.RecievedUserId });
                    table.ForeignKey(
                        name: "FK_Friendships_Users_RecievedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JoinedChatsId = table.Column<int>(type: "int", nullable: false),
                    ParticipantsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatParticipants", x => new { x.JoinedChatsId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_ChatParticipants_Chats_JoinedChatsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_RecievedUserId",
                table: "Friendships",
