...
function Popup({
  ...
  return (
    isOpen && (
      <div
        className="px-4 animate-fadeIn h-screen fixed inset-0 w-screen flex justify-center items-center bg-gray-500 bg-opacity-30 dark:bg-dark-primary dark:bg-opacity-50 z-50"
        style={{ margin: 0 }}
      >
