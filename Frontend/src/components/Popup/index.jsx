  ...
  return (
    isOpen && (
      <div className="px-4 flex-center overlay" style={{ margin: 0 }}>
        <div className="animate-swipeDown bg-white dark:bg-dark-secondary py-8 px-8 w-full md:w-2/3 lg:w-1/2 flex flex-col justify-between items-start rounded-xl space-y-6">
